...
namespace our {
    ...
    public:
        ...
        T* addComponent(){
            ...
            // set the owner of component to this entity
            component->owner = this;

            // push it into the components list
        ...
        T* getComponent(){
            ...
            //
            //auto it = std::find(components.begin(), components.end, static_cast<std::string>(T::getID()));
